...
void main() {
  group('JsonTree()', () {
    group('constructor', () {
      test('should create a tree with correct item and children', () {
        const tree = JsonTree(
          item: {'root': 'node'},
          children: {
            'child': JsonTree(item: {'child': 'node'}, children: {}),
          },
        );
    ...
    test('JsonTree should be immutable', () {
      const tree = JsonTree(item: {'immutable': true}, children: {});
    ...
    group('example()', () {
      test('should return a valid example tree', () {
        final example = JsonTree.example();
    ...
    group('fromJson, toJson', () {
      test('should serialize and deserialize correctly', () {
        final original = JsonTree.example();
        ...
        final deserialized = JsonTree.fromJson(json);
